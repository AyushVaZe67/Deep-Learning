...
public class ElectronicsSubjectsScreen extends AppCompatActivity {
    ...
    private String[] questions = {
            ...
            "2. Which component stores electrical energy?",
            "3. What is the function of a diode?",
            "4. What unit is used to measure resistance?",
            "5. Which device amplifies electronic signals?"
    };

    private String[][] options = {
            {"Light Emitting Diode", "Low Energy Device", "Linear Electrical Diode", "Light Energy Diode"},
            {"Resistor", "Capacitor", "Transistor", "Diode"},
            {"Amplifies signals", "Allows current in one direction", "Stores energy", "Blocks voltage completely"},
