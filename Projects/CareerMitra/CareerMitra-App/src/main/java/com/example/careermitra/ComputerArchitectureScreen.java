...
public class ComputerArchitectureScreen extends AppCompatActivity {
    ...
    private String[] questions = {
            ...
            "4. Which component connects the CPU and main memory?",
            "5. What type of memory is ROM?"
    };

    private String[][] options = {
            {"Central Processing Unit", "Control Processing Unit", "Central Programming Unit", "Compute Processing Unit"},
            {"ROM", "Hard Disk", "RAM", "SSD"},
            {"Arithmetic Logic Unit", "Array Logic Unit", "Advanced Logic Unit", "Automatic Logic Unit"},
            {"Control Unit", "Bus", "Cache", "Register"},
            {"Volatile Memory", "Non-Volatile Memory", "Temporary Memory", "None of the above"}
    };
